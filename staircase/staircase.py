...
#         <Colors>r g b...</Colors> (if sorting by index, you can instead specify unique colors 
#                                            for each level, must include legend)
...
def staircase_plot(input_file_name):
