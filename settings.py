...
<<<<<<< HEAD
latex_format = {'A1g':r"I=1 $A_{1g}$",'F1':r"$F_1$",'F2':r"$F_2$",'G': r'$G$','G1': r"$G_1$",'G1g': r"$G_{1g}$",'G1u': r"$G_{1u}$",'G2': r"$G_2$", 'Hg': r"$H_g$", 'Hu': r"$H_u$", 'N': r'$\textup{N}$', 'pi':r"$\pi$",'T1g':r"I=0 $T_{1g}$"}
=======
...
>>>>>>> 69125308d538634fe4b9bed7f495e4154af9d565
